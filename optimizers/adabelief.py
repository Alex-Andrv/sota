    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for g in group['params']:
                ...
                changed_grad = (grad-exp_avg)#modified to adabelief

                exp_avg_sq.mul_(beta2).addcmul_(1.0 - beta2, changed_grad, changed_grad).add_(group['eps'])#modified to adabelief
